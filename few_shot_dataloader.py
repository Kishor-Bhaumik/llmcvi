...
def load_custom_dataset(dataset_name, root_dir="datasets"):
    ...
    if dataset_name == "snippets":
        ...
        train_df = pd.read_csv(train_path, sep="\t", header=None, names=["label", "text"], usecols=[1, 2])
        test_df  = pd.read_csv(test_path,  sep="\t", header=None, names=["label", "text"], usecols=[1, 2])
