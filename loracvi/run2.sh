...
python cvi_qlora.py DEVICE=1 USE_SILHOUETTE=True "+few_shots={0:50, 1:50, 2:50, 3:50}" RUN_NAME='fewshot50SL'
python cvi_qlora.py DEVICE=1 USE_SILHOUETTE=True "+few_shots={0:30, 1:30, 2:30, 3:30}" RUN_NAME='fewshot30SL'
python cvi_qlora.py DEVICE=1 USE_SILHOUETTE=True "+few_shots={0:10, 1:10, 2:10, 3:10}" RUN_NAME='fewshot10SL'
