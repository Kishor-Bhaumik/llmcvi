...
# Add clustering components for silhouette
    ...
    def training_step(self, batch, batch_idx):
        ...
        silhouette_loss = self.slt_score(self.num_clusters, embeddings, goal=self.goal)

        self.log('train_loss', silhouette_loss, on_step=False, on_epoch=True, prog_bar=True)
